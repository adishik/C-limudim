...
linuxClean:
	rm -rf *.o
	rm cluster
final:  actionTable.o instructions.o intNode.o parser.o symbolTable.o firstScan.o secondScan.o filesCreator.o main.o
	gcc  actionTable.o instructions.o intNode.o parser.o symbolTable.o firstScan.o secondScan.o  filesCreator.o main.o -o final $(LIBS)
...
secondScan.o: secondScan.c
	gcc $(FLAGS) -c secondScan.c
filesCreator: filesCreator.o
	gcc filesCreator.o -o filesCreator $(LIBS)
filesCreator.o: filesCreator.c
	gcc $(FLAGS) -c filesCreator.c
main: main.o
